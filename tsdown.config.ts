...
/**
 * Build the package root as an independent node bundle, plus the browser
 * client bundle the harness web shell discovers through the `dsh.client`
 * declaration + exports["./client"].
 *
...
const CLIENT_ID = '@visol-456/dsh-cost-tracker'
